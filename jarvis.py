...
speak("Hello My Name is Jervis, How can i help you Today!")
...
def play_music():
    music_dir = "D:\FSDS With Gen AI bootcamp\JARVIS-Voice-Assistant-System\music"   # <-- change this to your music folder
    try:
...
while True:
    ...
    # Small talk
        ...
        speak("I was created by MIM, a brilliant mind!")
